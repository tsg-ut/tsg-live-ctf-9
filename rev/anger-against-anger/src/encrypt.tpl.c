...
int main(){
  ...
  size_t enc_flag_len=(flag_len%BLOCK_SIZE_BYTE==0?flag_len:(flag_len/BLOCK_SIZE_BYTE+1)*BLOCK_SIZE_BYTE );
  print_string_literal(FLAG,enc_flag_len);
  AES_CBC_decrypt_buffer(&ctx,(uint8_t*)FLAG,enc_flag_len);
}
